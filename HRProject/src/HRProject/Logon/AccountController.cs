    ...
    public class AccountController : Controller
    {
        ...
        public async Task<IActionResult> Login(LoginViewModel model, string returnUrl = null)
        {
            ...
            if (ModelState.IsValid)
            {
                ...
                // TODO: 1) PasswordSignInAsync uses UserName, not Email
        ...
        public async Task<IActionResult> PromoteToHr([FromBody] User regUser, string userName)
        {
            if (regUser == null)
            {
                return BadRequest();
            ...
            {
                await _userManager.AddToRoleAsync(todo, "HrManager");
            }
            return Ok("PromotedToHr");
        }

        //Promote To SuperUser
        [Authorize(Roles = "SuperUser")]
        [HttpPut("PromoteToSuper/{userName}")]
        public async Task<IActionResult> PromoteToSuper([FromBody] User regUser, string userName)
        {
            if (regUser == null)
            {
                return BadRequest();
            ...
            {
                await _userManager.AddToRoleAsync(todo, "SuperUser");
            }
            return Ok("PromotedToSuper");
        }
